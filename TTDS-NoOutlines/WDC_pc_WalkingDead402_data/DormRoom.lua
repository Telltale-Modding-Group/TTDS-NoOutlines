...
-- Command line: A:\Work\MODDING\Github\TTDS-NoOutlines\WDC_pc_WalkingDead402_data\DormRoom_temp.lua 

-- params : ...
-- function num : 0 , upvalues : _ENV
local kScript = "DormRoom"
local kScene = "adv_dormRoom"
local mFlashbackLightingController = nil
...
DormRoom_FlashbackLightingEnable = function(bEnable)
  -- function num : 0_2 , upvalues : _ENV, mFlashbackLightingController
